    ...
    <div class="vibe-content">
      ...
      <main class="main-area">
          ...
          <div class="playlist-info">
            ...
            <div class="playlist-details">
              ...
              <div class="playlist-meta">
                ...
                <span class="playlist-tracks">{{ playlist.tracks.length }}곡</span>
        ...
        <div class="playlist-content">
          ...
          <section class="section">
            <div class="section-header">
              <h2 class="section-title">관련 플레이리스트</h2>
            ...
            <div class="playlist-grid">
              <div
                ...
                class="playlist-card"
                @click="goToPlaylist(relatedPlaylist.id)"
              >
                <div class="playlist-image">
                  <img :src="relatedPlaylist.image" :alt="relatedPlaylist.title" />
                  <div class="play-overlay">
                    <button class="play-btn">
                      <VIcon name="mdi:play" class="w-6 h-6" />
                    </button>
                ...
                <div class="playlist-info">
                  <h3 class="playlist-title">{{ relatedPlaylist.title }}</h3>
                  <p class="playlist-desc">{{ relatedPlaylist.description }}</p>
                  <p class="playlist-tracks">{{ relatedPlaylist.trackCount }}곡</p>
                </div>
              </div>
            </div>
          </section>
