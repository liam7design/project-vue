    ...
    <div class="vibe-content">
      ...
      <main class="main-area">
        ...
        <div class="artist-header">
          <div class="artist-info">
            ...
            <div class="artist-details">
              ...
              <p class="artist-type">아티스트</p>
              <div class="artist-stats">
                <span class="stat-item">{{ artist.followers }} 팔로워</span>
                <span class="stat-item">{{ artist.albums.length }}개 앨범</span>
                <span class="stat-item">{{ artist.tracks.length }}곡</span>
              </div>
        ...
        <div class="artist-content">
            ...
            <div class="album-grid">
              ...
              >
                ...
                <div class="album-info">
                  ...
                  <p class="album-date">{{ album.year }}</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section class="section">
            <div class="section-header">
              <h2 class="section-title">관련 아티스트</h2>
              <button class="more-btn">더보기</button>
            </div>
            ...
            <div class="artist-grid">
              <div
                ...
                class="artist-card"
                @click="goToArtist(relatedArtist.id)"
              >
                <div class="artist-image">
                ...
                <div class="artist-info">
                  <h3 class="artist-name">{{ relatedArtist.name }}</h3>
                  <p class="artist-followers">{{ relatedArtist.followers }} 팔로워</p>
                </div>
              </div>
            </div>
          </section>
