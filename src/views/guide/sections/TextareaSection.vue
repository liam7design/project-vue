  ...
  >
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div class="text-center">
          <VTextarea variant="outlined" class="mb-2" />
          <p class="text-sm text-gray-600">outlined</p>
        </div>
        <div class="text-center">
          <VTextarea variant="filled" class="mb-2" />
          <p class="text-sm text-gray-600">filled</p>
        </div>
        <div class="text-center">
          <VTextarea variant="solo" class="mb-2" />
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <div class="text-center">
          <VTextarea color="primary" class="mb-2" />
          <p class="text-sm text-gray-600">primary</p>
        </div>
        <div class="text-center">
          <VTextarea color="secondary" class="mb-2" />
          <p class="text-sm text-gray-600">secondary</p>
        </div>
        <div class="text-center">
          <VTextarea color="success" class="mb-2" />
          <p class="text-sm text-gray-600">success</p>
        </div>
        <div class="text-center">
          <VTextarea color="warning" class="mb-2" />
          <p class="text-sm text-gray-600">warning</p>
        </div>
        <div class="text-center">
          <VTextarea color="error" class="mb-2" />
          <p class="text-sm text-gray-600">error</p>
        </div>
        <div class="text-center">
          <VTextarea color="info" class="mb-2" />
    ...
    <div class="mb-8">
      ...
      <div class="flex items-center gap-4">
        <VTextarea size="small" />
        <VTextarea size="default" />
        <VTextarea size="large" />
      </div>
    </div>
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <VTextarea label="정상 상태" />
        <VTextarea label="비활성화" disabled />
        <VTextarea label="로딩 상태" loading />
        <VTextarea label="에러 상태" :error="true" />
      </div>
    </div>

    <!-- 인터랙티브 데모 -->
    <template #interactive>
      <InteractiveDemo :props="demoProps" component-name="VTextarea">
        <template #controls>
          <div class="space-y-4">
            <div>
...
import { ref } from 'vue'
import { VTextarea } from '@/components/ui'
...
const TextareaProps = [
  { name: 'label', type: 'string', default: '', description: 'Textarea의 라벨' },
  { name: 'color', type: 'string', default: 'primary', description: 'Textarea의 색상' },
  { name: 'size', type: 'string', default: 'default', description: 'Textarea의 크기' },
...
const codeExample = 'VTextarea 컴포넌트 사용 예시'
</script>
