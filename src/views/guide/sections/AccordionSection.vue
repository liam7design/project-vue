  ...
  >
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div class="text-center">
          <VAccordion variant="default" class="mb-2" />
          <p class="text-sm text-gray-600">default</p>
        </div>
        <div class="text-center">
          <VAccordion variant="bordered" class="mb-2" />
          <p class="text-sm text-gray-600">bordered</p>
        </div>
        <div class="text-center">
          <VAccordion variant="elevated" class="mb-2" />
          <p class="text-sm text-gray-600">elevated</p>
        </div>
        <div class="text-center">
          <VAccordion variant="flat" class="mb-2" />
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <div class="text-center">
          <VAccordion color="primary" class="mb-2" />
          <p class="text-sm text-gray-600">primary</p>
        </div>
        <div class="text-center">
          <VAccordion color="secondary" class="mb-2" />
          <p class="text-sm text-gray-600">secondary</p>
        </div>
        <div class="text-center">
          <VAccordion color="success" class="mb-2" />
          <p class="text-sm text-gray-600">success</p>
        </div>
        <div class="text-center">
          <VAccordion color="warning" class="mb-2" />
          <p class="text-sm text-gray-600">warning</p>
        </div>
        <div class="text-center">
          <VAccordion color="error" class="mb-2" />
          <p class="text-sm text-gray-600">error</p>
        </div>
        <div class="text-center">
          <VAccordion color="info" class="mb-2" />
    ...
    <div class="mb-8">
      ...
      <div class="flex items-center gap-4">
        <VAccordion size="small" />
        <VAccordion size="default" />
        <VAccordion size="large" />
      </div>
    </div>
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <VAccordion label="정상 상태" />
        <VAccordion label="비활성화" disabled />
        <VAccordion label="로딩 상태" loading />
        <VAccordion label="에러 상태" :error="true" />
      </div>
    </div>

    <!-- 인터랙티브 데모 -->
    <template #interactive>
      <InteractiveDemo :props="demoProps" component-name="VAccordion">
        <template #controls>
          <div class="space-y-4">
            <div>
...
const AccordionProps = [
  { name: 'label', type: 'string', default: '', description: 'Accordion의 라벨' },
  { name: 'color', type: 'string', default: 'primary', description: 'Accordion의 색상' },
  { name: 'size', type: 'string', default: 'default', description: 'Accordion의 크기' },
...
const codeExample = 'VAccordion 컴포넌트 사용 예시'
</script>
