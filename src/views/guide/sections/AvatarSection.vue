  ...
  >
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
        <div class="text-center">
          <VAvatar variant="circular" class="mb-2" />
          <p class="text-sm text-gray-600">circular</p>
        </div>
        <div class="text-center">
          <VAvatar variant="rounded" class="mb-2" />
          <p class="text-sm text-gray-600">rounded</p>
        </div>
        <div class="text-center">
          <VAvatar variant="square" class="mb-2" />
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <div class="text-center">
          <VAvatar color="primary" class="mb-2" />
          <p class="text-sm text-gray-600">primary</p>
        </div>
        <div class="text-center">
          <VAvatar color="secondary" class="mb-2" />
          <p class="text-sm text-gray-600">secondary</p>
        </div>
        <div class="text-center">
          <VAvatar color="success" class="mb-2" />
          <p class="text-sm text-gray-600">success</p>
        </div>
        <div class="text-center">
          <VAvatar color="warning" class="mb-2" />
          <p class="text-sm text-gray-600">warning</p>
        </div>
        <div class="text-center">
          <VAvatar color="error" class="mb-2" />
          <p class="text-sm text-gray-600">error</p>
        </div>
        <div class="text-center">
          <VAvatar color="info" class="mb-2" />
    ...
    <div class="mb-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <VAvatar label="정상 상태" />
        <VAvatar label="비활성화" disabled />
        <VAvatar label="로딩 상태" loading />
        <VAvatar label="에러 상태" :error="true" />
      </div>
    </div>

    <!-- 인터랙티브 데모 -->
    <template #interactive>
      <InteractiveDemo :props="demoProps" component-name="VAvatar">
        <template #controls>
          <div class="space-y-4">
            <div>
...
const AvatarProps = [
  { name: 'label', type: 'string', default: '', description: 'Avatar의 라벨' },
  { name: 'color', type: 'string', default: 'primary', description: 'Avatar의 색상' },
  { name: 'size', type: 'string', default: 'default', description: 'Avatar의 크기' },
...
const codeExample = 'VAvatar 컴포넌트 사용 예시'
</script>
